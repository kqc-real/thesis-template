...
%%% Layout-Anpassung: Abstände verringern
% Überschriften-Abstände kompakter gestalten
...
% Absatzabstand manuell verringern (überschreibt KOMA-Script parskip=half Berechnung)
...
% Allow a larger emergency stretch to reduce occasional overfull boxes
% Increasing this gives TeX more flexibility to adjust spacing before reporting
% overfull/underfull hbox warnings; kept reasonably small to avoid poor spacing.
