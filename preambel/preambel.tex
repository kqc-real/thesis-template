...
\usepackage{xcolor}    % Farben für alternierende Zeilen

% Farben für alternierende Zeilen
\definecolor{rowcolorgray}{gray}{0.92}      % Hellgrau für jeden 2. Zeile
\definecolor{headercolor}{RGB}{70,130,180}  % Stahlblau für Header
\definecolor{headertext}{white}{1.0}        % Weiß für Header-Text
...
% Befehl für alternierende Zeilen-Färbung
\newcommand{\rowcolor}[1]{\gdef\currentrowcolor{#1}}
\newcommand{\cellcolor}[2]{\multicolumn{1}{>{\columncolor{#1}}l}{#2}}

% Alternative: Verwende \rowcolors aus xcolor
\usepackage{tabu}
\let\oldtabular\tabular
\let\endoldtabular\endtabular
\renewenvironment{tabular}{\rowcolors{2}{rowcolorgray}{white}\oldtabular}{\endoldtabular}
...
\lstloadlanguages{Python,Java,C,HTML,XML,JavaScript}
