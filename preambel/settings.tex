...
\KOMAoptions{%
   parskip=full, % full line spacing between paragraphs (German convention)
   % parskip=half, % half line spacing alternative
   % parskip=relative, % adjust according to fontsize
}%
%%% === Table of Contents =====================================================
