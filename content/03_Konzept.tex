...
Abbildung \ref{fig:agent-architektur} zeigt die Kernkomponenten der Architektur:\footnote{Vgl. \cite{miller2017chapter} für detaillierte Architekturprinzipien.}\index{Agentenarchitektur}
