...
\begin{quote}
\textit{\textquote[\cite{smith2020example}]{Agenten sind nicht einfach nur statische Werkzeuge, sondern adaptive Systeme, die in der Lage sind, ihre Strategien basierend auf Feedback anzupassen, mehrschrittige Aufgaben zu bewältigen und dabei ihre eigenen Grenzen zu verstehen. Sie werden die nächste Grenze der Softwareentwicklung prägen: nicht als Ersatz für menschliche Kreativität, sondern als Partner, die Routineaufgaben automatisieren, Qualität sichern und Entwickler bei komplexen Herausforderungen unterstützen.}}
\smallskip
\begin{flushright}
— John Smith, \textit{An Example Book}, 2020
\end{flushright}
\end{quote}
...
Die Ziele dieser Arbeit sind auf die Spezialisierung \enquote{Software Engineering mit agentic AI} zugeschnitten:\footnote{Siehe auch \cite{smith2020example} für verwandte Arbeiten zu Agentenarchitekturen.}
