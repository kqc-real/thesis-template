...
Dieses Kapitel führt in Grundbegriffe agentischer Systeme ein und bildet die theoretische Basis für Konzept und Implementierung \cite{smith2020example}.\footnote{Die Grundbegriffe basieren auf etablierten Konzepten aus der KI-Forschung, werden aber im Kontext von Software Engineering neu interpretiert.}
...
Relevante Muster sind \emph{Chain-of-Thought}, \emph{ReAct}, \emph{Tree-of-Thought}, \emph{Plan-and-Execute} sowie Graph-basierte Orchestrierung. Praxisnahe Frameworks bieten Funktionen für Tool-Anbindung, Speicherschichten und Kontrollfluss \cite{doe2019research}.\footnote{\emph{ReAct} steht für \enquote{Reasoning and Acting} und ist eines der einflussreichsten Muster für agentische Systeme in der neueren Literatur.}
