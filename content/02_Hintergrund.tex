...
\textbf{Reflexion} \cite{shinn2023reflexion} erweitert ReAct um Self-Critique: Der Agent bewertet seine eigenen Outputs und lernt aus Fehlern durch verbale Bestärkung. Dies verbessert die Erfolgsrate bei komplexen Tasks um bis zu \pct{20}.
...
\begin{itemize}
  \item \textbf{Langer Kontext:} Bei großen Codebases (\textgreater 100k LOC) stoßen selbst 1M-Token-Kontextfenster an Grenzen
