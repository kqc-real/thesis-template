...
\begin{itemize}
  ...
  \item \textbf{Kontextfenster:} Trotz Optimierung stoßen 128k-Token-Limits bei komplexen Codebasen an Grenzen. RAG/Chunking sind Workarounds, keine Lösungen.
...
\begin{itemize}
  ...
  \item \textbf{Optimiertes Kontextmanagement:} Hybrid-Strategien (RAG + Summarization + Code-Graph-Navigation) für 1M+ LOC Codebasen
