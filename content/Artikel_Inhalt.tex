...
Stärken & Tele\-metrie an vie\-le Emp\-fän\-ger,\allowbreak gutes Ecosystem & kurze \enquote{Wake-up-and-send}-Kommunikation, Web-nah \\
...
\begin{itemize}
  ...
  \item Updates einplanen: sichere OTA-Mechanismen sind kein \enquote{Nice-to-have}.
\end{itemize}
\end{infobox}
