...
In diesem Kapitel werden die praktischen Aspekte der Umsetzung dokumentiert\index{Implementierungspraxis}.\footnote{Implementierungsdetails orientieren sich an Best Practices aus \cite{martin2008clean}.}
...
\begin{sloppypar}
\begin{description}
  \item[Programmiersprache:] Python 3.11+\index{Python} (Typ-Hinweise\index{Type Hints}, Async/Await-Unterstützung\index{Async/Await})
...
\begingroup
  ...
  \begin{tabular}{L{2.6cm}C{1.6cm}C{1.6cm}C{1.6cm}C{1.4cm}C{1.9cm}}
\toprule
